...
O trabalho está organizado em quatro fases, seguindo uma abordagem incremental e acadêmica.
...
### 🎥 Fase 4 — IA Multimodal para Saúde da Mulher

- Análise de vídeo utilizando YOLOv8 Pose
- Extração de padrões corporais observáveis
- Análise de movimento corporal e postura
- Speech-to-Text com Azure Speech Services
- Análise de sentimento com Azure AI Language
- Extração automática de key phrases
- Fusão multimodal entre vídeo e áudio
- Geração de score consolidado de risco
- Classificação automática de risco
- Definição de necessidade de revisão humana
- Pipeline multimodal integrado executável
...
### ▶️ Execução Automatizada (Ajustado para o Pipeline da Fase 4)
...
- `Fase 4/01_video_analysis.ipynb`
→ Análise de vídeo utilizando YOLOv8 Pose

- `Fase 4/02_audio_analysis_azure.ipynb`
→ Speech-to-Text e análise de sentimento com Azure AI Language

- `Fase 4/03_multimodal_fusion.ipynb`
→ Consolidação multimodal e geração do score final
...
#### Métricas e outputs da Fase 4 estão salvos em:
...
#### Os resultados da Fase 4 incluem:
...
A solução da Fase 4 foi estruturada em etapas:

1. Processamento de vídeo com YOLOv8 Pose
2. Identificação de padrões corporais observáveis
3. Speech-to-Text com Azure Speech Services
4. Análise de sentimento com Azure AI Language
5. Extração de key phrases
6. Fusão multimodal dos resultados
7. Geração de score consolidado
8. Definição de revisão humana

Os diagramas estão disponíveis em:

- `artefatos/Fase 4/Diagrama Pipeline.png`
- `artefatos/Fase 4/Arquitetura Multimodal.png`
...
- Azure AI Language
- NLP aplicado à análise emocional
- Fusão multimodal heurística

#### Análise de Vídeo

- Pose Estimation
- Detecção de padrões corporais
...
A Fase 4 foi desenvolvida com foco em:

- Integração multimodal
- Aplicação prática de IA em saúde
- Utilização de serviços cognitivos em nuvem
- Separação entre modalidades de análise
